...
export const EXEMPLOS: Omit<Mensagem, 'id' | 'criadoEm' | 'atualizadoEm'>[] = [
  {
    ...
    objetivo: 'Mostrar que a salvação é dom de Deus, não conquista humana â€” e que isso transforma a forma como vivemos.',
    ...
    versiculos: [
      ...
      { livro: 'Tito', capitulo: '2', versiculos: '11', texto: 'Porque a graça de Deus se manifestouâ€¦', versao: 'ARA' },
    ],
    referenciasCruzadas: ['Romanos 3:24', 'Tito 2:11', 'João 1:16'],
    comentarios: 'Texto central da soteriologia paulina. Cuidado para não reduzir à graça genérica â€” Paulo fala de uma graça que INTERVÃ‰M.',
    contextoHistorico: 'Carta escrita por Paulo prisioneiro em Roma, por volta de 60-62 d.C., à igreja em Ã‰feso â€” cidade portuária multicultural com forte presença de cultos pagãos (Artemis).',
    aplicacoes: [
    ...
    frasesMarcantes: ['A graça não é o perdão do que eu fiz. Ã‰ o dom do que eu nunca poderia ser.'],
    perguntas: [
    ...
    conclusao: 'A graça não é o final do caminho â€” é o início de uma vida que já não precisa provar nada. Descanse. E viva.',
    tempoEstimado: 35,
    observacoes: 'Não falar mais de 35 min. Cuidar para que a ilustração da criança adotada não seja longa demais.',
    esboco:
      '<h2>1. O contexto revela o problema</h2><p>Paulo escreve a cristãos que ainda pensam por mérito.</p><h2>2. A verdade da graça se desdobra</h2><p>Salvos pela graça, mediante a fé â€” dom, não conquista.</p><h2>3. A graça exige resposta</h2><p>Quem recebe graça vive de modo diferente.</p>',
    conteudo:
      ...
      '<p>Três palavras sustentam tudo: <em>graça</em>, <em>fé</em>, <em>dom</em>. As três nos colocam na posição certa diante de Deus â€” não de quem conquista, mas de quem recebe.</p>' +
      ...
      '<p>Mas Paulo não pára na graça. Ele segue: somos <em>criados</em> em Cristo Jesus para boas obras. A graça vem primeiro. As obras vêm como fruto â€” não como condição.</p>' +
      '<p>Ã‰ como uma árvore boa: ela dá fruto porque é boa, não para se tornar boa. Assim é a vida em graça: ela produz porque recebeu, não para merecer.</p>',
    arquivos: [],
    igreja: 'Igreja Local',
  ...
  },
  {
    ...
    objetivo: 'Mostrar que Deus é um Deus que descansa â€” e que o descanso é parte do design original da criação.',
    ...
    comentarios: 'Descanso não é preguiça â€” é fé. O fato de Deus descansar mostra que a obra estava completa.',
    ...
    ilustracoes: [
      'O artista que assina a obra e dá um passo para trás â€” a contemplação completa a criação',
    ...
    esboco:
      '<h2>1. O detalhe que ninguém nota</h2><p>Deus descansa. E isso muda tudo.</p><h2>2. Descanso não é preguiça</h2><p>Ã‰ teologia â€” a obra estava completa.</p><h2>3. Descansar é confiar</h2><p>Ã‰ dizer: o mundo continua nas mãos de Deus.</p>',
    conteudo:
      ...
      '<p>Não descansou porque estava cansado. Descansou porque a obra estava completa. E quando o ser humano foi criado, foi criado para entrar nesse ritmo â€” não para viver no caos.</p>' +
  ...
  },
  {
    ...
    comentarios: 'Habacuque é o profeta da pergunta difícil â€” ele questiona Deus e Deus responde.',
    ...
    conclusao: '',
    tempoEstimado: 30,
    observacoes: 'Esboço inicial â€” ainda em desenvolvimento.',
